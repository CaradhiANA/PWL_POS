...
class PenjualanController extends Controller
{
    public function index()
    {
        ...
        $penjualan->map(function ($item) {
            $item->total_penjualan = Detailpenjualanmodel::where('penjualan_id', $item->penjualan_id)->sum('harga');
            $item->barang = Detailpenjualanmodel::where('penjualan_id', $item->penjualan_id)->with('barang')->get();
        });
    ...
    public function show($id)
    {
        ...
        $penjualan_detail = Detailpenjualanmodel::where('penjualan_id', $id)->with(['barang', 'penjualan'])->get();

        $total_penjualan = Detailpenjualanmodel::where('penjualan_id', $id)->sum('harga');
    ...
    public function update(Request $request, $id)
    {
        ...
        $penjualan_detail = Detailpenjualanmodel::where('penjualan_id', $id);
